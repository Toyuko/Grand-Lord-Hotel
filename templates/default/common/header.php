        ...
        <div class="container-fluid">
            <div id="mainMenu" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    foreach($menus['main'] as $nav_id => $nav){
                        if(empty($nav['id_parent']) || $nav['id_parent'] == $homepage['id']){ ?>
            ...
            <div class="navbar navbar-default">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo DOCBASE.LANG_ALIAS; ?>" title="<?php echo $homepage['title']; ?>"><img src="<?php echo getFromTemplate("images/logo.png"); ?>" alt="<?php echo SITE_TITLE; ?>"></a>
                </div>
            </div>
        </div>
    </div>
